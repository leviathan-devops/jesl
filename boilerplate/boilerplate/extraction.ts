...
const DIRS_TO_COPY = ["core", "nodes", "cli", "drivers", "scanners", "workflow", "packager", "wraps", "mpse", "bindings", "algorithms", "kernels", "boilerplate", "tests", "fixtures"] as const
const ROOT_FILES_TO_COPY = ["lexicon.ts", "lexicon.json"] as const
...
export const extractBoilerplate = (
  ...
  Effect.gen(function* () {
    ...
    const profileFiles = [`profiles/shared.ts`, `profiles/default.ts`, `profiles/trident.ts`, `profiles/trading.ts`, `profiles/sales.ts`] as const
